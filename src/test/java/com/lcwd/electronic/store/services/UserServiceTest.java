...
//        UserDto updatedUser=mapper.map(user,UserDto.class);
    ...
    public void getAllUsersTest() {
        ...
        Page<UserDto> allUser = userService.getAllUser(1, 2, "name", "asc");
    ...
    public void searchUserTest() {
        ...
        Mockito.when(userRepository.searchUser(keywords)).thenReturn(Arrays.asList(user, user1, user2, user3));
